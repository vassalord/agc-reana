...
def construct_fileset(n_files_max_per_sample, use_xcache=False, af_name="", local_data_cache=None, input_from_eos=False, xcache_atlas_prefix=None):
    ...
    xsec_info = {
        ...
        "zprimett1000": 3.528e+00,
        "zprimett1200": 1.749e+00,
        "zprimett2000": 1.951e-01,
        "zprimett2500": 4.743e-02,
        "zprimett3000": 1.494e-02,
        "zprimett3500": 5.097e-03,
        "zprimett400": 2.547e+01,
        "zprimett4000": 1.900e-03,
        "zprimett4500": 7.521e-04,
        "zprimett500": 2.559e+01,
        "zprimett5000": 3.193e-04,
        "zprimett600": 1.809e+01,
        "zprimett6000": 6.167e-05,
        "zprimett700": 1.144e+01,
        "zprimett7000": 1.140e-05,
        "zprimett800": 7.736e+00,
        "zprimett8000": 1.839e-06,
        "zprimett900":5.181e+00,
        "zprimett9000": 1.993e-07,  # cross section after matching in pb
        "data": None
    }
